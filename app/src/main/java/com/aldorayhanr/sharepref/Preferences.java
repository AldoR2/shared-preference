...
public class Preferences {
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     * yang memiliki key KEY_USERNAME_SEDANG_LOGIN dengan paramater username */
    ...
    public static void setLoggedInStatus(Context context, boolean status){
        SharedPreferences.Editor editor = Preferences.getSharedPreference(context).edit();
     ...
     * khusus data yang memiliki key KEY_USERNAME_SEDAN_LOGIN dan KEY_STATUS_SEDANG_LOGIN*/
